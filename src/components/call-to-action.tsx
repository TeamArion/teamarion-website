  ...
  return (
    <section className="py-20 md:py-24" ref={sectionRef}>
      <div className="container">
        <motion.div
          animate={{ backgroundPositionX: 1000 }} // ✅ replaced .width with fixed scroll offset
          transition={{ duration: 120, repeat: Infinity, ease: "linear" }}
          className="border border-muted py-24 px-6 rounded-xl overflow-hidden relative group"
          style={{ backgroundImage: `url(${BackgroundStars})`, backgroundPositionY }}
        >
          <div
          ...
          <motion.div
            ...
            style={{ backgroundImage: `url(${BackgroundGrid})`, maskImage }}
            ref={borderedDivRef}
          />
